...
public final class Autos {
  ...
  public static final Command exampleAuto(CANDriveSubsystem driveSubsystem) {
    return new SequentialCommandGroup(
            ...
            driveSubsystem.driveArcade(driveSubsystem, () -> 1, () -> 0.0, () -> 0.5).withTimeout(1.5)
    );
  }

  public static final Command middleScore(CANDriveSubsystem driveSubsystem, CANRollerSubsystem rollerSubsystem) {
    return new SequentialCommandGroup(
  ...
  public static final Command rightScore(CANDriveSubsystem driveSubsystem, CANRollerSubsystem rollerSubsystem) {
    return new SequentialCommandGroup(
            ...
            driveSubsystem.driveArcade(driveSubsystem, () -> 0, () -> 0.4, () -> 0.5).withTimeout(3),
  ...
  public static final Command rightScoreCoral(CANDriveSubsystem driveSubsystem, CANRollerSubsystem rollerSubsystem) {
    return new SequentialCommandGroup(
            driveSubsystem.driveArcade(driveSubsystem, () -> 1, () -> 0.0, () -> 0.5).withTimeout(3),
            driveSubsystem.driveArcade(driveSubsystem, () -> 0, () -> 1, () -> 0.5).withTimeout(0.5),
            driveSubsystem.driveArcade(driveSubsystem, () -> 1, () -> 0.0, () -> 0.5).withTimeout(1),
            rollerSubsystem.runRoller(rollerSubsystem, () -> 0.5, () -> 0, () -> 1).withTimeout(1.5),
            driveSubsystem.driveArcade(driveSubsystem, () -> -1, () -> 0.0, () -> 0.5).withTimeout(1),
            driveSubsystem.driveArcade(driveSubsystem, () -> 0, () -> -1, () -> 0.5).withTimeout(0.5),
  ...
  public static final Command rightScoreCoralScore(CANDriveSubsystem driveSubsystem, CANRollerSubsystem rollerSubsystem) {
    return new SequentialCommandGroup(
            driveSubsystem.driveArcade(driveSubsystem, () -> 1, () -> 0.0, () -> 0.5).withTimeout(3),
            driveSubsystem.driveArcade(driveSubsystem, () -> 0, () -> 1, () -> 0.5).withTimeout(0.5),
            driveSubsystem.driveArcade(driveSubsystem, () -> 1, () -> 0.0, () -> 0.5).withTimeout(1),
            ...
            driveSubsystem.driveArcade(driveSubsystem, () -> 0, () -> 1, () -> 0.5).withTimeout(1.5),
            driveSubsystem.driveArcade(driveSubsystem, () -> -1, () -> 0.0, () -> 0.5).withTimeout(5),
            driveSubsystem.driveArcade(driveSubsystem, () -> 0, () -> 0.0, () -> 0.5).withTimeout(1),
            driveSubsystem.driveArcade(driveSubsystem, () -> 1, () -> 0.0, () -> 0.5).withTimeout(5),
            rollerSubsystem.runRoller(rollerSubsystem, () -> 0.5, () -> 0, () -> 1).withTimeout(1.5)
            );
  }
